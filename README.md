...
> 个人定制版本，主要更换了背景图片，新增了若干接口，修复一些问题（比如把部分顶部导航栏子功能关闭后，功能大项自动隐藏），适配个人博客使用。所有代码已开源，欢迎参考。
>
...
感谢以下贡献者对原项目做出的贡献，如有问题或建议，请提交 [Issue](https://github.com/CuteLeaf/Firefly/issues) 或 [Pull Request](https://github.com/CuteLeaf/Firefly/pulls)。
